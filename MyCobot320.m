...
%% Constructor 
        function self = MyCobot320(baseTr)
            ...
            %%% Check default workspace self.workspace = [-0.8 0.8 -0.8 0.8 -0.01 0.5];   
...
%% CreateModel
        function CreateModel(self)
            link(1) = Link('d', 0.17390, 'a', 0, 'alpha', pi/2, 'qlim', deg2rad([-165 165]));
            link(2) = Link('d', -0.08878, 'a', 0.135, 'alpha', 0, 'qlim', deg2rad([-165 165]));
            link(3) = Link('d', 0.08878, 'a', 0.120, 'alpha', 0, 'qlim', deg2rad([-165 165]));
            link(4) = Link('d', -0.08878, 'a', 0, 'alpha', -pi/2, 'qlim', deg2rad([-165 165]));
            link(5) = Link('d', 0.09500, 'a', 0, 'alpha', -pi/2, 'qlim', deg2rad([-165 165]));
            link(6) = Link('d', -0.0655, 'a', 0, 'alpha', 0, 'qlim', deg2rad([-175 175]));
